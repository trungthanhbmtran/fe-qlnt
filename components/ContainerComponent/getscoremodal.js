...
const GetScoreModal = ({openModal,_on_Toggle_Modal,nameMethod,dataUpdateForm,_on_fetch}) =>{
  // const DepartmentsObject = UseInputSelect(`department`,{key :'ID_Donvi', value :'TENDONVI'})
  const DepartmentsObject = UseInputSelect(`department`,ProccesCondition('ID_Donvi','TENDONVI'),ProccesCondition('LoaiDV',2))
  // const BranchesObject = UseInputSelect(`branches`,{key :'ID_Nganhnghe', value :'Ten_Nganhnghe'})
  const BranchesObject = UseInputSelect(`branches`,ProccesCondition('ID_Nganhnghe','Ten_Nganhnghe'),ProccesCondition('ID_Donvi',parseInt(DepartmentsObject.value)))
